...
let tareas = [
  { id: generarID(), name: "Hacer mercado", done: false },
  { id: generarID(), name: "Estudiar para la prueba", done: false },
  { id: generarID(), name: "Sacar a pasear a Tobby", done: false },
];
...
const render = () => {
  const tableContent = tareas
    .map((tarea) => {
      ...
      <button onclick="editar(${tarea.id})"><i class="fa-regular fa-pen-to-square" style="color: yellow;"></i></button>
      <button onclick="borrar(${tarea.id})"><i class="fa-regular fa-trash-can" style="color: red;"></i></button>
        </td>
